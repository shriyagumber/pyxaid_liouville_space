...
public:
  ...
  // Constructors
  me_state(){}
  me_state(vector<int>& as_,vector<int>& cs_){ active_space = as_; actual_state = cs_; Exc = 0.0; Eshift = 0.0; }

  // Basically the constructor
  void set_me_state(vector<int>& as_,vector<int>& cs_){ active_space = as_; actual_state = cs_; Exc = 0.0; Eshift = 0.0; }
